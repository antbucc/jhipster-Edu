...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './educator.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EDUCATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_EDUCATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EDUCATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EDUCATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EDUCATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EDUCATOR actions', async () => {
      const expectedActions = [
        {
