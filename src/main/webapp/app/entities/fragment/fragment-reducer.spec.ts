...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './fragment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRAGMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_FRAGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FRAGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FRAGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FRAGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FRAGMENT actions', async () => {
      const expectedActions = [
        {
