...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './goal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GOAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_GOAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GOAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GOAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GOAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GOAL actions', async () => {
      const expectedActions = [
        {
