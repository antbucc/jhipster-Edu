...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './condition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONDITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONDITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONDITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONDITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONDITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONDITION actions', async () => {
      const expectedActions = [
        {
