...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './effect.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EFFECT_LIST actions', async () => {
    ...
    it('dispatches FETCH_EFFECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EFFECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EFFECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EFFECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EFFECT actions', async () => {
      const expectedActions = [
        {
