...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './concept.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONCEPT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONCEPT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONCEPT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONCEPT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONCEPT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONCEPT actions', async () => {
      const expectedActions = [
        {
