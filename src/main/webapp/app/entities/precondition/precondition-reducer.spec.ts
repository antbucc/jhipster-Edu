...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRECONDITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRECONDITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRECONDITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRECONDITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRECONDITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRECONDITION actions', async () => {
      const expectedActions = [
        {
