...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './scenario.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCENARIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCENARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCENARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCENARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCENARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCENARIO actions', async () => {
      const expectedActions = [
        {
