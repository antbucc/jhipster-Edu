    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="eduApp.scenario.module">Module</Translate>
          </dt>
          <dd>
            {scenarioEntity.modules
              ? scenarioEntity.modules.map((val, i) => (
                  <span key={val.id}>
                    <a>{val.id}</a>
                    {scenarioEntity.modules && i === scenarioEntity.modules.length - 1 ? '' : ', '}
                  </span>
                ))
              : null}
          </dd>
