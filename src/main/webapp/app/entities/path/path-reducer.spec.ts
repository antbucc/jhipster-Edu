...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './path.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PATH_LIST actions', async () => {
    ...
    it('dispatches FETCH_PATH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PATH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PATH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PATH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PATH actions', async () => {
      const expectedActions = [
        {
