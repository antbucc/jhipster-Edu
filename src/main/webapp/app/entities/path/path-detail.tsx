...
export const PathDetail = () => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2 data-cy="pathDetailsHeading">
          <Translate contentKey="eduApp.path.detail.title">Path</Translate>
        </h2>
        ...
        &nbsp;
        <Button tag={Link} to={`/path/${pathEntity.id}/edit`} replace color="primary">
